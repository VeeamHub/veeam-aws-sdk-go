...
// RegionsPage struct for RegionsPage
...
func (o RegionsPage) MarshalJSON() ([]byte, error) {
...
type NullableRegionsPage struct {
	value *RegionsPage
	isSet bool
}

func (v NullableRegionsPage) Get() *RegionsPage {
	return v.value
}

func (v *NullableRegionsPage) Set(val *RegionsPage) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionsPage) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionsPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionsPage(val *RegionsPage) *NullableRegionsPage {
	return &NullableRegionsPage{value: val, isSet: true}
}

func (v NullableRegionsPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionsPage) UnmarshalJSON(src []byte) error {
	v.isSet = true

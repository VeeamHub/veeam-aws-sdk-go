...
// RegionSettingsPage struct for RegionSettingsPage
type RegionSettingsPage struct {
	TotalCount int32 `json:"totalCount"`
	Results []RegionSettings `json:"results"`
...
func (o RegionSettingsPage) MarshalJSON() ([]byte, error) {
...
type NullableRegionSettingsPage struct {
	value *RegionSettingsPage
	isSet bool
}

func (v NullableRegionSettingsPage) Get() *RegionSettingsPage {
	return v.value
}

func (v *NullableRegionSettingsPage) Set(val *RegionSettingsPage) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionSettingsPage) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionSettingsPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionSettingsPage(val *RegionSettingsPage) *NullableRegionSettingsPage {
	return &NullableRegionSettingsPage{value: val, isSet: true}
}

func (v NullableRegionSettingsPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionSettingsPage) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// APIClient manages communication with the Veeam Backup for AWS public API 1.0 API v1.0-rev0
...
type APIClient struct {
	...
	AmazonConnectionsApi *AmazonConnectionsApiService

	BucketsApi *BucketsApiService

	CertificatesApi *CertificatesApiService

	CostEstimationApi *CostEstimationApiService

	EmailNotificationsApi *EmailNotificationsApiService

	IAMRolesApi *IAMRolesApiService

	InstancesApi *InstancesApiService

	LicenseAgreementApi *LicenseAgreementApiService
	...
	RetentionSettingsApi *RetentionSettingsApiService

	SMTPServerCredentialsRecordsApi *SMTPServerCredentialsRecordsApiService
	...
	VmRestorePointsApi *VmRestorePointsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AmazonConnectionsApi = (*AmazonConnectionsApiService)(&c.common)
	c.BucketsApi = (*BucketsApiService)(&c.common)
	c.CertificatesApi = (*CertificatesApiService)(&c.common)
	c.CostEstimationApi = (*CostEstimationApiService)(&c.common)
	c.EmailNotificationsApi = (*EmailNotificationsApiService)(&c.common)
	c.IAMRolesApi = (*IAMRolesApiService)(&c.common)
	c.InstancesApi = (*InstancesApiService)(&c.common)
	c.LicenseAgreementApi = (*LicenseAgreementApiService)(&c.common)
	...
	c.RetentionSettingsApi = (*RetentionSettingsApiService)(&c.common)
	c.SMTPServerCredentialsRecordsApi = (*SMTPServerCredentialsRecordsApiService)(&c.common)
	...
	c.VmRestorePointsApi = (*VmRestorePointsApiService)(&c.common)
...
// Custom time parsing handler
func (t *Time) UnmarshalJSON(b []byte) error {
	// converting time to string
	strT := string(b)
	// removing quotes
	strT = strT[1 : len(strT)-1]
	// parsing using custom layout
	parsed, err := time.Parse("2006-01-02T15:04:05", strT)
	if err != nil {
		panic(err)
	}
